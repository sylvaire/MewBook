...
- 当前构建事实来自 `app/build.gradle.kts`：`minSdk = 26`、`targetSdk = 34`、`versionCode = 8`、`versionName = "1.0.7"`。
...
- Statistics: weekly/monthly/yearly charts, income/expense summaries, category breakdown, and category expense drilldown with record detail view, edit, and delete.
- Assets and ledgers: account CRUD, ledger management, default ledger behavior, manual ordering.
...
- WebDAV credentials and URLs should stay redacted in logs and docs.
