...
- 当前构建事实来自 `app/build.gradle.kts`：`minSdk = 26`、`targetSdk = 34`、`versionCode = 16`、`versionName = "1.2.2"`。
- 当前 Room 数据库事实来自 `MewBookDatabase.kt`：数据库名 `mewbook.db`，版本 `7`，`exportSchema = false`。
