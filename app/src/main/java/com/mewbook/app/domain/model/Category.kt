...
object DefaultCategories {
    private val baseExpenseCategories = listOf(
        ...
        Category(name = "下午茶", icon = "local_cafe", color = 0xFFBCA7E5, type = RecordType.EXPENSE, isDefault = true, sortOrder = 0),
        Category(name = "外卖", icon = "takeout_dining", color = 0xFF4ECDC4, type = RecordType.EXPENSE, isDefault = true, sortOrder = 0),
        Category(name = "奶茶", icon = "local_drink", color = 0xFFFF69B4, type = RecordType.EXPENSE, isDefault = true, sortOrder = 0),
        Category(name = "咖啡", icon = "local_cafe", color = 0xFF8B4513, type = RecordType.EXPENSE, isDefault = true, sortOrder = 0),
        Category(name = "茶饮", icon = "emoji_food_beverage", color = 0xFF8BC34A, type = RecordType.EXPENSE, isDefault = true, sortOrder = 0),
        Category(name = "肉类", icon = "restaurant", color = 0xFFE57373, type = RecordType.EXPENSE, isDefault = true, sortOrder = 0),
        Category(name = "蔬菜", icon = "eco", color = 0xFF81C784, type = RecordType.EXPENSE, isDefault = true, sortOrder = 0),
        Category(name = "公交", icon = "directions_bus", color = 0xFF4ECDC4, type = RecordType.EXPENSE, isDefault = true, sortOrder = 0),
        Category(name = "地铁", icon = "train", color = 0xFF45B7D1, type = RecordType.EXPENSE, isDefault = true, sortOrder = 0),
        Category(name = "打车", icon = "local_taxi", color = 0xFFF38181, type = RecordType.EXPENSE, isDefault = true, sortOrder = 0),
        Category(name = "油费", icon = "local_gas_station", color = 0xFFFFC107, type = RecordType.EXPENSE, isDefault = true, sortOrder = 0),
        Category(name = "停车", icon = "local_parking", color = 0xFF95A3A4, type = RecordType.EXPENSE, isDefault = true, sortOrder = 0),
        Category(name = "火车", icon = "train", color = 0xFF795548, type = RecordType.EXPENSE, isDefault = true, sortOrder = 0),
        Category(name = "飞机", icon = "flight", color = 0xFF2196F3, type = RecordType.EXPENSE, isDefault = true, sortOrder = 0),
        Category(name = "服装", icon = "checkroom", color = 0xFFFFE66D, type = RecordType.EXPENSE, isDefault = true, sortOrder = 0),
        Category(name = "数码", icon = "devices", color = 0xFF7C83FD, type = RecordType.EXPENSE, isDefault = true, sortOrder = 0),
        Category(name = "日用品", icon = "cleaning_services", color = 0xFF95E1D3, type = RecordType.EXPENSE, isDefault = true, sortOrder = 0),
        Category(name = "化妆品", icon = "face", color = 0xFFFCBAD3, type = RecordType.EXPENSE, isDefault = true, sortOrder = 0),
        Category(name = "家电", icon = "kitchen", color = 0xFF607D8B, type = RecordType.EXPENSE, isDefault = true, sortOrder = 0),
        Category(name = "房租", icon = "house", color = 0xFF95E1D3, type = RecordType.EXPENSE, isDefault = true, sortOrder = 0),
        Category(name = "水电费", icon = "water_drop", color = 0xFF45B7D1, type = RecordType.EXPENSE, isDefault = true, sortOrder = 0),
        Category(name = "物业费", icon = "manage_accounts", color = 0xFFAA96DA, type = RecordType.EXPENSE, isDefault = true, sortOrder = 0),
        Category(name = "燃气", icon = "local_fire_department", color = 0xFFFF5722, type = RecordType.EXPENSE, isDefault = true, sortOrder = 0),
        Category(name = "话费", icon = "phone_android", color = 0xFF4CAF50, type = RecordType.EXPENSE, isDefault = true, sortOrder = 0),
        Category(name = "电影", icon = "movie", color = 0xFFAA96DA, type = RecordType.EXPENSE, isDefault = true, sortOrder = 0),
        Category(name = "游戏", icon = "sports_esports", color = 0xFF7C83FD, type = RecordType.EXPENSE, isDefault = true, sortOrder = 0),
        Category(name = "旅游", icon = "flight", color = 0xFF4ECDC4, type = RecordType.EXPENSE, isDefault = true, sortOrder = 0),
        Category(name = "健身", icon = "fitness_center", color = 0xFFFF6B6B, type = RecordType.EXPENSE, isDefault = true, sortOrder = 0),
        Category(name = "演唱会", icon = "music_note", color = 0xFFFF4081, type = RecordType.EXPENSE, isDefault = true, sortOrder = 0),
        Category(name = "ktv", icon = "mic", color = 0xFF9C27B0, type = RecordType.EXPENSE, isDefault = true, sortOrder = 0),
        Category(name = "手机话费", icon = "phone_android", color = 0xFF45B7D1, type = RecordType.EXPENSE, isDefault = true, sortOrder = 0),
        Category(name = "宽带费", icon = "wifi", color = 0xFF2196F3, type = RecordType.EXPENSE, isDefault = true, sortOrder = 0),
        Category(name = "健身房", icon = "fitness_center", color = 0xFF4CAF50, type = RecordType.EXPENSE, isDefault = true, sortOrder = 0),
        Category(name = "运动装备", icon = "sports_basketball", color = 0xFFFF9800, type = RecordType.EXPENSE, isDefault = true, sortOrder = 0),
        Category(name = "游泳", icon = "pool", color = 0xFF00BCD4, type = RecordType.EXPENSE, isDefault = true, sortOrder = 0),
        Category(name = "宠物食品", icon = "pets", color = 0xFFFF9F43, type = RecordType.EXPENSE, isDefault = true, sortOrder = 0),
        Category(name = "宠物医疗", icon = "local_hospital", color = 0xFFF38181, type = RecordType.EXPENSE, isDefault = true, sortOrder = 0),
        Category(name = "宠物用品", icon = "shopping_bag", color = 0xFFFFE66D, type = RecordType.EXPENSE, isDefault = true, sortOrder = 0),
        Category(name = "红包", icon = "card_giftcard", color = 0xFFFF69B4, type = RecordType.EXPENSE, isDefault = true, sortOrder = 0),
        Category(name = "请客", icon = "restaurant", color = 0xFFFF6B6B, type = RecordType.EXPENSE, isDefault = true, sortOrder = 0),
        Category(name = "书籍", icon = "menu_book", color = 0xFF5D4037, type = RecordType.EXPENSE, isDefault = true, sortOrder = 0),
        Category(name = "文具", icon = "edit", color = 0xFF9E9E9E, type = RecordType.EXPENSE, isDefault = true, sortOrder = 0),
        Category(name = "电子书", icon = "tablet_android", color = 0xFF607D8B, type = RecordType.EXPENSE, isDefault = true, sortOrder = 0),
        Category(name = "游戏充值", icon = "sports_esports", color = 0xFF9C27B0, type = RecordType.EXPENSE, isDefault = true, sortOrder = 0),
        Category(name = "会员订阅", icon = "star", color = 0xFFFFD700, type = RecordType.EXPENSE, isDefault = true, sortOrder = 0),
        Category(name = "软件订阅", icon = "cloud", color = 0xFF2196F3, type = RecordType.EXPENSE, isDefault = true, sortOrder = 0),
        Category(name = "直播打赏", icon = "favorite", color = 0xFFE91E63, type = RecordType.EXPENSE, isDefault = true, sortOrder = 0),
